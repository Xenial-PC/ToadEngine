...
public class Window : GameWindow
{
    ...
    protected override void OnFramebufferResize(FramebufferResizeEventArgs e)
    {
        ...
        GUI.UI.SetResolution(e.Width, e.Height);
        GUI.CanvasRenderer.UpdateProjection(e.Width, e.Height);
        OnResize(e);
    }
    ...
    {
        base.OnMouseDown(e);
        var btn = TranslateMouseButton(e.Button);
        GUI.UI.SetPointerState(btn, MouseState.X, MouseState.Y, true, false);
    }
    ...
    protected override void OnMouseUp(MouseButtonEventArgs e)
    {
        base.OnMouseUp(e);
        var btn = TranslateMouseButton(e.Button);
        GUI.UI.SetPointerState(btn, MouseState.X, MouseState.Y, false, false);
    }

    protected override void OnMouseWheel(MouseWheelEventArgs e)
    {
        base.OnMouseWheel(e);
       GUI.UI.SetPointerWheel(e.OffsetY);
    }

    protected override void OnMouseMove(MouseMoveEventArgs e)
    {
        base.OnMouseMove(e);
        GUI.UI.SetPointerState(PaperMouseBtn.Unknown, MouseState.X, MouseState.Y, false, true);
    }

    protected override void OnKeyDown(KeyboardKeyEventArgs e)
    {
        base.OnKeyDown(e);
        GUI.UI.SetKeyState(TranslateKey(e.Key), true);
    }

    protected override void OnKeyUp(KeyboardKeyEventArgs e)
    {
        base.OnKeyUp(e);
        GUI.UI.SetKeyState(TranslateKey(e.Key), false);
    }

    protected override void OnTextInput(TextInputEventArgs e)
    {
        base.OnTextInput(e);
        GUI.UI.AddInputCharacter(e.AsString);
    }
