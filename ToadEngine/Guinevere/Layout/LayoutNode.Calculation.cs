...
public partial class LayoutNode
{
    ...
    public float CalculateWidth(float availableWidth)
    {
    ...
    public float CalculateHeight(float availableHeight)
    {
    ...
    public float CalculateContentWidth(float availableWidth)
    {
