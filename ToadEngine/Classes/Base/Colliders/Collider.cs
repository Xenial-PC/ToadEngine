...
{
    public class Collider : MonoBehavior
    {
        public BodyHandle BHandle;
        public StaticHandle SHandle;
        public int Handle;
        ...
        public void Update()
        {
            ...
            var body = simulation.Bodies.GetBodyReference(BHandle);
        ...
        public void Resize(dynamic shape)
        {
            ...
            {
                var sBody = Physics.Simulation.Statics.GetStaticReference(SHandle);
                Physics.Simulation.Shapes.Remove(sBody.Shape);
                sBody.SetShape(shapeIndex);
                return;
            }

            var body = Physics.Simulation.Bodies.GetBodyReference(BHandle);
